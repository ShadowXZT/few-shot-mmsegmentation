...
class BaseSegmentor(BaseModule, metaclass=ABCMeta):
    ...
    @auto_fp16(apply_to=('query_img', ))
    def forward(self, query_img, img_metas, return_loss=True, **kwargs):
        ...
        """
        if return_loss:
            return self.forward_train(query_img, img_metas, **kwargs)
        else:
            return self.forward_test(query_img, img_metas, **kwargs)
